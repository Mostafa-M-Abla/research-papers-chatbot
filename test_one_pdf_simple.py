...
#old format_docs, when retriever was part of teh chain and we dont show teh part from which teh LLM got his answer
#def format_docs(docs):
...
# 7) QA chain (no retrieval inside; we pass context explicitly)
qa_chain = prompt | llm | StrOutputParser()

# 8) Interactive loop with citations
